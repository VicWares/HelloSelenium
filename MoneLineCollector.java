...
public class MoneyLineCollector
{
    ...
    private HashMap<String, String> homeMoneylineCloseOddsMap = new HashMap<>();
    public void collectMoneyLines(WebDriver driver, HashMap<String, String> xRefMap) throws InterruptedException
    {
        ...
        try//Get away moneyline close odds column AH34
        {
            for (Map.Entry<String, String> entry : xRefMap.entrySet())
            {
                ...
                String[] moneyLineOdds = element.findElement(By.cssSelector(".__american")).getText().split(" ");
                String awayMoneylineCloseOdds = moneyLineOdds[0];
        ...
        try//Get home moneyline close odds column S19
        {
            for (Map.Entry<String, String> entry : xRefMap.entrySet())
            {
                String dataEventId = entry.getKey();
                ...
                //                WebElement element = driver.findElement(By.cssSelector("[data-game='" + dataGame + "'][data-book='bet365'][data-type='moneyline']"));
                //                String[] moneyLineOdds = element.findElement(By.cssSelector(".__american")).getText().split(" ");
                //                String homeMoneylineCloseOdds = moneyLineOdds[0];
                //                awayMoneylineCloseOddsMap.put(dataEventId, homeMoneylineCloseOdds);
            }
        }
        catch (Exception e)
        {
    ...
    public HashMap<String, String> getHomeMoneylineCloseOddsMap()
    {
        return homeMoneylineCloseOddsMap;
    }
}
